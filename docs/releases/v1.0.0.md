...
|:----------|:------------|:------------|:------------|:---------|
| **Cello v1.0.0** | **134,000+** | **2.5ms** | **10ms** | **1.0x (baseline)** |
...
|:--------|:-----|:-----------|
| **v1.0.0** | 2026-02-21 | Production-ready stable release, 134K+ req/s (4w), 160K+ (8w), API stability |

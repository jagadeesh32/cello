...
app.enable_openapi(title="Cello Feature Showcase", version="0.9.0")
...
app.register_singleton("config", {"debug": True, "version": "0.9.0"})
...
def health_check(request):
    ...
    return {"status": "healthy", "framework": "cello", "version": "0.9.0"}
